...
class ModExt(ScriptedLoadableModule):
  ...
  def __init__(self, parent):
    ...
    self.parent.title = "ModExt" # TODO make this more human readable by adding spaces
...
class ModExtWidget(ScriptedLoadableModuleWidget):
...
class ModExtLogic(ScriptedLoadableModuleLogic):
  ...
  def run(self, inputVolume, outputVolume, imageThreshold, enableScreenshots=0):
    ...
    if enableScreenshots:
      self.takeScreenshot('ModExtTest-Start','MyScreenshot',-1)
